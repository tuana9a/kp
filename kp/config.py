...
DEFAULT_PROXMOX_VM_ID_RANGE = [100, 99999]
DEFAULT_PROXMOX_PRESERVED_VM_IDS = []
DEFAULT_PROXMOX_PRESERVED_VM_IPS = []
...
class Cfg:
    def __init__(self,
                 ...
                 vm_id_range: List[int] = None,
                 vm_preserved_ids: List[int] = None,
                 vm_preserved_ips: List[str] = None,
                 vm_ssh_keys: str = "",
                 vm_name_prefix="i-",
                 **kwargs) -> None:
        if not vm_id_range:
            vm_id_range = DEFAULT_PROXMOX_VM_ID_RANGE
        if not vm_preserved_ids:
            vm_preserved_ids = []
        if not vm_preserved_ips:
            vm_preserved_ips = []
